# Tetrominoes
This project is my realization of the classic Tetris game. It is written in C language using SDL2 libraries for rendering graphics and controlling input devices (currently keyboard).
# Installing
